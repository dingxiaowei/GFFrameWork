...
{
    unsafe class GFFramework_VersionContorller_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GFFramework.VersionContorller);
        ...
        static StackObject* Start_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GFFramework.VersionContorller.Start(@serverConfigPath, @localConfigPath, @onProcess, @onError);
