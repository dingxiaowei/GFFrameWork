...
{
    unsafe class GFFramework_GFLauncher_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GFFramework.GFLauncher);
            args = new Type[]{typeof(System.Action)};
            method = type.GetMethod("set_OnFixUpdate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_OnFixUpdate_0);
            args = new Type[]{typeof(System.Action)};
        ...
        static StackObject* set_OnFixUpdate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GFFramework.GFLauncher.OnFixUpdate = value;
        ...
        static StackObject* set_OnUpdate_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GFFramework.GFLauncher.OnUpdate = value;
        ...
        static StackObject* set_OnLateUpdate_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GFFramework.GFLauncher.OnLateUpdate = value;
