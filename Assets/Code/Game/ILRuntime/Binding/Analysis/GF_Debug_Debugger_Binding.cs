...
{
    unsafe class GF_Debug_Debugger_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GF.Debug.Debugger);
            ...
            args = new Type[]{typeof(System.String), typeof(System.String), typeof(UnityEngine.Object)};
        ...
        static StackObject* Log_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GF.Debug.Debugger.Log(@message, @color);
        ...
        static StackObject* Log_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GF.Debug.Debugger.Log(@tag, @message);
        ...
        static StackObject* LogError_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GF.Debug.Debugger.LogError(@message, @color, @context);
        ...
        static StackObject* LogFormat_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GF.Debug.Debugger.LogFormat(@format, @args);
