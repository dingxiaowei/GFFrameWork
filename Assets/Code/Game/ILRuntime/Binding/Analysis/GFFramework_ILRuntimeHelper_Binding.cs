...
{
    unsafe class GFFramework_ILRuntimeHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GFFramework.ILRuntimeHelper);
            args = new Type[]{};
        ...
        static StackObject* get_AppDomain_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GFFramework.ILRuntimeHelper.AppDomain;
