...
using Utils = GFFramework.Helper.Utils;
using GF.Debug;

namespace GFFramework.ResourceMgr
{
    /// <summary>
    ///ab包引用计数类
    /// </summary>
    ...
    public class AssetBundleMgr : IResMgr
    {
        ...
        public AssetBundleMgr(string root)
        {
            ...
            Debugger.Log("Art加载路径:" + artRootPath,"red");
            //通知到GFFrameLife
        }
        ...
        public void LoadCancel(int taskid)
        {
            if (willDoTaskSet.Contains(taskid))
            {
                ...
                Debugger.Log("BResource 移除task:" + taskid);
            }
        }
