...
public abstract class WindowBase
{
    ...
    public WindowBase(string path)
    {
        resourcePath = path;
        subWindowsDictionary = new Dictionary<string, SubWindow>();
    }

    public WindowBase(Transform transform)
    {
    ...
    virtual public void Destroy()
    {
        ...
        if (Transform)
        {
            CResources.Destroy(this.Transform);
        }
        ...
        IsLoad = false;
        //卸载窗口
        CResources.UnloadAsset(resourcePath);
    }
