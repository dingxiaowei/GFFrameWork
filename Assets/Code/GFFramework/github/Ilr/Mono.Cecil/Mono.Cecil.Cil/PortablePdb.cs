...
namespace Mono.Cecil.Cil {
	...
	static class PdbGuidMapping {
		...
		static PdbGuidMapping ()
		{
			...
			AddMapping (DocumentLanguage.Smc, new Guid ("0d9b9f7b-6611-11d3-GF2a-0000f80849GF"));
		...
		static readonly Guid type_text = new Guid ("5a869d0b-6611-11d3-GF2a-0000f80849GF");
